...
const MODULE_POINTS = {
  // Básico (1-10)
  'que-es-el-trading': 10, 'tipos-de-mercados-y-activos': 10, 'como-funciona-un-broker': 10,
  'el-spread-y-los-costos': 10, 'apalancamiento-y-margen': 10, 'pips-lotes-y-valor': 10,
  'plataformas-y-tipos-de-orden': 10, 'velas-japonesas': 10, 'patrones-de-velas-basicos': 10,
  'demo-antes-que-real': 10,
  // Intermedio (11-20)
  'soporte-y-resistencia': 15, 'tendencias-y-estructura-de-mercado': 15, 'lineas-de-tendencia-y-canales': 15,
  'medias-moviles-a-fondo': 15, 'rsi-y-divergencias': 15, 'macd-y-momentum': 15, 'indicadores-basicos': 15,
  'figuras-geometricas-chartismo': 15, 'fibonacci-retrocesos': 15, 'gestion-de-riesgo-tamano-posicion': 15,
  // Avanzado (21-30)
  'ratio-riesgo-beneficio': 20, 'multiples-temporalidades': 20, 'volumen-y-order-flow': 20,
  'smart-money-concepts-intro': 20, 'price-action-sin-indicadores': 20, 'correlaciones-y-diversificacion': 20,
  'sesiones-de-mercado-horarios': 20, 'plan-de-trading-y-bitacora': 20, 'psicologia-del-trading-introduccion': 20,
  'backtesting-y-mejora-continua': 20
};

const PREMIUM_MODULE_POINTS = {
  'mesa-institucional-como-opera': 30, 'microestructura-libro-de-ordenes': 30, 'liquidez-institucional-stop-hunts': 30,
  'order-blocks-validacion': 30, 'fair-value-gaps-ineficiencias': 30, 'estructura-avanzada-bos-choch': 30,
  'volume-profile-poc-va': 30, 'market-profile-subastas': 30, 'vwap-institucional': 30,
  'order-flow-delta-lectura': 30, 'informe-cot-posicionamiento': 30, 'sesiones-killzones-liquidez': 30,
  'intermercado-dxy-bonos': 30, 'macro-tasas-flujos': 30, 'riesgo-institucional-var-correlacion': 30,
  'ejecucion-profesional-twap-vwap': 30, 'dark-pools-bloques': 30, 'opciones-gamma-dealers': 30,
  'backtesting-walk-forward': 30, 'proceso-desk-playbook-metricas': 30
};
